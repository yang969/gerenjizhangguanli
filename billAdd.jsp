...
<div class="panel panel-default" id="userPic">
    ...
    <div class="panel-body">
        <form action="${pageContext.request.contextPath}/billAddAction" method="post" class="form-horizontal">
            <div class="modal-content">
                ...
                <div class="modal-body text-center row">
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="billCode" name="billCode">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="billDesc" id="billDesc">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary updatePro" type="submit">添加</button>
